...
export const Form = () => {
  ...
  const { categories, fetchCategories, addItem , items} = useItems()
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      addItem(result.item)
      console.log('result item form.js');
      console.log(items);
  ...
  return (
    ...
    <form className="w-full pt-10" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="mb-5 mt-5">
        ...
        <input type="number" id="price-input" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <button type="submit" className="text-white bg-black hover:bg-black-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add</button>
    </form>
  )
}